...
recordify(Obj) -> % Replace binary keys by atom key, and detect values types
                  ...
                  % Create record
                  V = lists:flatmap(fun({_, V}) -> [V] end, R),
