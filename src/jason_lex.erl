...
yystate(36, [10|Ics], Line, Tlen, _, _) ->
    yystate(36, Ics, Line+1, Tlen+1, 14, Tlen);
...
yystate(34, [102|Ics], Line, Tlen, Action, Alen) ->
...
yystate(34, [43|Ics], Line, Tlen, Action, Alen) ->
...
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 42 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 59, C =< 68 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 70, C =< 90 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 94, C =< 100 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 109 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 115 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 126, C =< 255 ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(27, [52|Ics], Line, Tlen, Action, Alen) ->
...
yystate(26, [10|Ics], Line, Tlen, _, _) ->
    yystate(36, Ics, Line+1, Tlen+1, 12, Tlen);
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 11 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/jason_lex.xrl", 8).
yyaction_0(TokenLine) ->
     { token, { 'b-a', TokenLine, '[' } } .

-compile({inline,yyaction_1/1}).
-file("src/jason_lex.xrl", 9).
yyaction_1(TokenLine) ->
     { token, { 'e-a', TokenLine, ']' } } .

-compile({inline,yyaction_2/1}).
-file("src/jason_lex.xrl", 10).
yyaction_2(TokenLine) ->
     { token, { 'b-o', TokenLine, '{' } } .

-compile({inline,yyaction_3/1}).
-file("src/jason_lex.xrl", 11).
yyaction_3(TokenLine) ->
     { token, { 'e-o', TokenLine, '}' } } .

-compile({inline,yyaction_4/1}).
-file("src/jason_lex.xrl", 12).
yyaction_4(TokenLine) ->
     { token, { 'n-s', TokenLine, ':' } } .

-compile({inline,yyaction_5/1}).
-file("src/jason_lex.xrl", 13).
yyaction_5(TokenLine) ->
     { token, { 'v-s', TokenLine, ',' } } .

-compile({inline,yyaction_6/1}).
-file("src/jason_lex.xrl", 14).
yyaction_6(TokenLine) ->
     { token, { false, TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/jason_lex.xrl", 15).
yyaction_7(TokenLine) ->
     { token, { null, TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/jason_lex.xrl", 16).
yyaction_8(TokenLine) ->
     { token, { true, TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/jason_lex.xrl", 17).
yyaction_9(TokenLine) ->
     { token, { minus, TokenLine, '-' } } .

-compile({inline,yyaction_10/1}).
-file("src/jason_lex.xrl", 18).
yyaction_10(TokenLine) ->
     { token, { plus, TokenLine, '+' } } .

-compile({inline,yyaction_11/1}).
-file("src/jason_lex.xrl", 19).
yyaction_11(TokenLine) ->
     { token, { 'd-p', TokenLine, '.' } } .

-compile({inline,yyaction_12/2}).
-file("src/jason_lex.xrl", 20).
yyaction_12(TokenChars, TokenLine) ->
     { token, { exponent, TokenLine, TokenChars } } .

-compile({inline,yyaction_13/2}).
-file("src/jason_lex.xrl", 22).
yyaction_13(TokenChars, TokenLine) ->
     { token, { digits, TokenLine, TokenChars } } .

-compile({inline,yyaction_14/0}).
-file("src/jason_lex.xrl", 25).
yyaction_14() ->
     skip_token .

-compile({inline,yyaction_15/3}).
-file("src/jason_lex.xrl", 27).
yyaction_15(TokenChars, TokenLen, TokenLine) ->
...
-file("src/jason_lex.xrl", 34).
yyaction_16(TokenChars, TokenLine) ->
     { token, { chr, TokenLine, unicode : characters_to_binary (TokenChars) } } .
